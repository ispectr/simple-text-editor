...
void MainWindow::setupActions()
{
	...
	QAction* setFilenameAction = new QAction(this);
	setFilenameAction->setText(i18n("&SetFilename"));
	setFilenameAction->setIcon(QIcon::fromTheme("accessories-text-editor"));
	connect(setFilenameAction, &QAction::triggered,
	    this, &MainWindow::setFileName);

	actionCollection()->setDefaultShortcut(clearAction, Qt::CTRL + Qt::Key_W);
	actionCollection()->setDefaultShortcut(setFilenameAction, Qt::CTRL + Qt::Key_F);
	actionCollection()->addAction("clear", clearAction);
	actionCollection()->addAction("set file name", setFilenameAction);
...
void MainWindow::setFileName()
{
	...
	QString text = QInputDialog::getText(0, "Set filename",
